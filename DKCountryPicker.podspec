#
#  Be sure to run `pod spec lint DKCountryPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dkasper/DKCountryPicker.git", :commit => "f1726a5511050d17fef3787eab0e0190db6454b4" }
  ...
  s.source_files  = 'Classes/DKCountryPickerViewController.{h,m}'
